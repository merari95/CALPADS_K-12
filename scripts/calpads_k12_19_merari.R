...
suppression_cols <- star_scan(cupc_1819_k12)$columns
...
table(cupc_1819_k12$charter, cupc_1819_k12$charter_dummy)
str(cupc_1819_k12$charter_dummy)

### now onto the school type variable
### the numbering label scheme is just alphabetical order
table(cupc_1819_k12$school_type)
cupc_1819_k12 <- cupc_1819_k12 %>% 
  mutate(
...
table(cupc_1819_k12$school_type, cupc_1819_k12$school_type_num)
str(cupc_1819_k12$school_type_num)

## same process for ed_option_type variable 
table(cupc_1819_k12$ed_option_type)
cupc_1819_k12 <- cupc_1819_k12 %>% 
  mutate(
...
cupc_1819_k12 <- cupc_1819_k12 %>% 
  mutate(
    nslp_status = na_if(as.character(nslp_status), "N/A"),
    nslp_status_num = case_when(
      as.character(nslp_status) == "Breakfast Provision 2" ~ 1,
      as.character(nslp_status) == "CEP" ~ 2,
      as.character(nslp_status) == "Lunch Provision 2" ~ 3,
      as.character(nslp_status) == "Provision 2" ~ 4
    )
  ) %>% 
  mutate(nslp_status_num = as.integer(nslp_status_num))
table(cupc_1819_k12$nslp_status, cupc_1819_k12$nslp_status_num)
str(cupc_1819_k12$nslp_status_num)

## same process for charter_funding variable 
table(cupc_1819_k12$charter_funding)
cupc_1819_k12 <- cupc_1819_k12 %>% 
  mutate(
...
table(cupc_1819_k12$charter_funding, cupc_1819_k12$charter_funding_num)
str(cupc_1819_k12$charter_funding_num)

## same process for irc variable 
table(cupc_1819_k12$irc)
cupc_1819_k12 <- cupc_1819_k12 %>% 
  mutate(
...
table(cupc_1819_k12$irc, cupc_1819_k12$irc_num)
str(cupc_1819_k12$irc_num)

## same process with low_grade variable 
table(cupc_1819_k12$low_grade)
cupc_1819_k12 <- cupc_1819_k12 %>% 
  mutate(
...
table(cupc_1819_k12$low_grade, cupc_1819_k12$low_grade_num)
str(cupc_1819_k12$low_grade_num)

## same process with high_grade variable
table(cupc_1819_k12$high_grade)
cupc_1819_k12 <- cupc_1819_k12 %>% 
  mutate(
...
table(cupc_1819_k12$high_grade, cupc_1819_k12$high_grade_num)
str(cupc_1819_k12$high_grade_num)

## last but not least, calpads_fall1_cert
table(cupc_1819_k12$calpads_fall1_cert)
cupc_1819_k12 <- cupc_1819_k12 %>% 
  mutate(
...
table(cupc_1819_k12$calpads_fall1_cert, cupc_1819_k12$calpads_fall1_cert_num)
str(cupc_1819_k12$calpads_fall1_cert_num)
...
cupc_1819_k12 <- pad_cds_codes(cupc_1819_k12)
view(cupc_1819_k12)
...
#!           data_description = "2018-19 calpads upc k-12 file",
...
cupck12_19_dims <- get_dim_objects()

validate_primary_key(cupck12_19_entities_dim, "cds", full_run = T)
#! safe_fwrite(cupck12_19_entities_dim, table_name = "cupck12_19_entities",
#!             dimension_type = "annualized", data_source = "cde",
#!             data_year = 2019, data_type = "dim",
#!             data_description = "2018-19 calpads k-12 upc entities dim table",
#!             user_note = "dim table.")

validate_primary_key(dim19_cupck12_districts, "district_code", full_run = T)
#! safe_fwrite(dim19_cupck12_districts, table_name = "cupck12_19_districts",
#!             data_year = 2019, data_source = "cde",
#!             dimension_type = "annualized", data_type = "dim",
#!             data_description = "unique list of school districts calpads k-12 upc 2019.",
#!             user_note = "dim table.")

validate_primary_key(dim19_cupck12_schools, "school_code", full_run = T)
#! safe_fwrite(dim19_cupck12_schools, table_name = "cupck12_19_schools",
#!             data_year = 2019, data_source = "cde",
#!             dimension_type = "annualized", data_type = "dim",
#!             data_description = "unique list of school schools calpads k-12 upc 2019.",
#!             user_note = "dim table.")

validate_primary_key(dim19_cupck12_ed_option_type, "ed_option_type_num", full_run = T)
#! safe_fwrite(dim19_cupck12_ed_option_type, table_name = "dim19_cupck12_ed_option_type",
#!             data_year = 2019, data_source = "cde",
#!             dimension_type = "annualized", data_type = "dim",
...
#!             data_year = 2019, data_source = "cde",
#!             dimension_type = "annualized", data_type = "dim",
#!             data_description = "dimension table for nslp status.",
#!             user_note = "dim table.")

validate_primary_key(dim19_cupck12_charter_funding, "charter_funding_num", full_run = T)
#! safe_fwrite(dim19_cupck12_charter_funding, table_name = "dim19_cupck12_charter_funding",
#!             data_year = 2019, data_source = "cde",
#!             dimension_type = "annualized", data_type = "dim",
#!             data_description = "dimension table for charter funding in calpads upc k-12.",
#!             user_note = "dim table.")

validate_primary_key(dim19_cupck12_irc, "irc_num", full_run = T)
#! safe_fwrite(dim19_cupck12_irc, table_name = "dim19_cupck12_irc",
#!             data_year = 2019, data_source = "cde",
#!             dimension_type = "annualized", data_type = "dim",
#!             data_description = "dimension table for whether an LEA is an independently reporting charter in calpads upc k-12.",
#!             user_note = "dim table.")

validate_primary_key(dim19_cupck12_low_grade, "low_grade_num", full_run = T)
#! safe_fwrite(dim19_cupck12_low_grade, table_name = "dim19_cupck12_low_grade",
#!             data_year = 2019, data_source = "cde",
#!             dimension_type = "annualized", data_type = "dim",
#!             data_description = "dimension table for an LEAs lowest grade in calpads upc k-12.",
#!             user_note = "dim table.")

validate_primary_key(dim19_cupck12_high_grade, "high_grade_num", full_run = T)
#! safe_fwrite(dim19_cupck12_high_grade, table_name = "dim19_cupck12_high_grade",
#!             data_year = 2019, data_source = "cde",
#!             dimension_type = "annualized", data_type = "dim",
#!             data_description = "dimension table for an LEAs highest grade in calpads upc k-12.",
#!             user_note = "dim table.")

validate_primary_key(dim19_cupck12_calpads_fall1_cert, "calpads_fall1_cert_num", full_run = T)
#! safe_fwrite(dim19_cupck12_calpads_fall1_cert, table_name = "dim19_cupck12_calpads_fall1_cert",
#!             data_year = 2019, data_source = "cde",
#!             dimension_type = "annualized", data_type = "dim",
...
#~ setwd("T:/CDE data releases/Enrollment Data/CALPADS UPC Grades K-12/2018-19")
setwd("/Users/merarisantana/Desktop/OCDE/CALPADS_K-12/data/raw") #@
cupc_1819_k12_school <- readxl::read_excel("cupc1819-k12.xlsx", sheet = "School-Level CALPADS UPC Data", skip = 1) #$

# this is a custom function we created to compare variable names across datasets
# variables between the two are the same 
compare_variable_names(cupc_1819_k12, cupc_1819_k12_school)

#checking data types for all variables and looking through data
str(cupc_1819_k12_school)
view(cupc_1819_k12_school)

# Step 3: Cleaning and renaming columns ####
##clean_names function just makes all names lowercase and removes spaces and replaces with underscore
cupc_1819_k12_school <- cupc_1819_k12_school %>% 
  clean_names()
names(cupc_1819_k12_school)
...
#### this data has no suppression
suppression_cols <- star_scan(cupc_1819_k12_school)$columns
...
### any variable that is has categorical options, we want to convert to a numeric dummy
### starting with an indicator for whether a school is a charter school or not
table(cupc_1819_k12_school$charter)
cupc_1819_k12_school <- cupc_1819_k12_school %>%
  mutate(
    charter = na_if(as.character(charter), "N/A"),
    charter_dummy = case_when(
  ...
  mutate(charter_dummy = as.integer(charter_dummy))
table(cupc_1819_k12_school$charter, cupc_1819_k12_school$charter_dummy)
str(cupc_1819_k12_school$charter_dummy)

### now onto the school type variable
### the numbering label scheme is just alphabetical order
table(cupc_1819_k12_school$school_type)
cupc_1819_k12_school <- cupc_1819_k12_school %>% 
  mutate(
    school_type = na_if(as.character(school_type), "N/A"),
    school_type_num = case_when(
  ...
  mutate(school_type_num = as.integer(school_type_num))
table(cupc_1819_k12_school$school_type, cupc_1819_k12_school$school_type_num)
str(cupc_1819_k12_school$school_type_num)

## same process for ed_option_type variable 
table(cupc_1819_k12_school$ed_option_type)
cupc_1819_k12_school <- cupc_1819_k12_school %>% 
  mutate(
    ed_option_type = na_if(as.character(ed_option_type), "N/A"),
    ed_option_type_num = case_when(
...
cupc_1819_k12_school <- cupc_1819_k12_school %>% 
  mutate(
    ...
    nslp_status_num = case_when(
      ...
      as.character(nslp_status) == "CEP" ~ 2,
      as.character(nslp_status) == "Lunch Provision 2" ~ 3,
      as.character(nslp_status) == "Provision 1" ~ 4,
      as.character(nslp_status) == "Provision 2" ~ 5,
      as.character(nslp_status) == "Provision 3" ~ 6
    )
  ) %>% 
  mutate(nslp_status_num = as.integer(nslp_status_num))
table(cupc_1819_k12_school$nslp_status, cupc_1819_k12_school$nslp_status_num)
str(cupc_1819_k12_school$nslp_status_num)

## same process for charter_funding variable 
table(cupc_1819_k12_school$charter_funding)
cupc_1819_k12_school <- cupc_1819_k12_school %>% 
  mutate(
    charter_funding = na_if(as.character(charter_funding), "N/A"),
    charter_funding_num = case_when(
  ...
  mutate(charter_funding_num = as.integer(charter_funding_num))
table(cupc_1819_k12_school$charter_funding, cupc_1819_k12_school$charter_funding_num)
str(cupc_1819_k12_school$charter_funding_num)

## same process for irc variable 
table(cupc_1819_k12_school$irc)
cupc_1819_k12_school <- cupc_1819_k12_school %>% 
  mutate(
    irc = na_if(as.character(irc), "N/A"),
    irc_num = case_when(
  ...
  mutate(irc_num = as.integer(irc_num))
table(cupc_1819_k12_school$irc, cupc_1819_k12_school$irc_num)
str(cupc_1819_k12_school$irc_num)

## same process with low_grade variable 
table(cupc_1819_k12_school$low_grade)
cupc_1819_k12_school <- cupc_1819_k12_school %>% 
  mutate(
    low_grade = na_if(as.character(low_grade), "N/A"),
    low_grade_num = case_when(
  ...
  mutate(low_grade_num = as.integer(low_grade_num))
table(cupc_1819_k12_school$low_grade, cupc_1819_k12_school$low_grade_num)
str(cupc_1819_k12_school$low_grade_num)

## same process with high_grade variable
table(cupc_1819_k12_school$high_grade)
cupc_1819_k12_school <- cupc_1819_k12_school %>% 
  mutate(
    high_grade = na_if(as.character(high_grade), "N/A"),
    high_grade_num = case_when(
  ...
  mutate(high_grade_num = as.integer(high_grade_num))
table(cupc_1819_k12_school$high_grade, cupc_1819_k12_school$high_grade_num)
str(cupc_1819_k12_school$high_grade_num)

## last but not least, calpads_fall1_cert
table(cupc_1819_k12_school$calpads_fall1_cert)
cupc_1819_k12_school <- cupc_1819_k12_school %>% 
  mutate(
    calpads_fall1_cert_num = case_when(
      as.character(calpads_fall1_cert) == "In Expected List But We Do Not Have Data For This School/LEA" ~ 0, 
...
### CDS code is the unique identifier the state gives to each school. We have the three pieces of CDS 
### code in this file (county, district and school code) so we concatenate those to make cds
cupc_1819_k12_school <- pad_cds_codes(cupc_1819_k12_school)
view(cupc_1819_k12_school)
...
## we now check the primary key which uniquely identifies each row
## more info on primary keys: https://www.geeksforgeeks.org/dbms/primary-key-in-dbms/
validate_primary_key(cupc_1819_k12_school_fact, c("cds"), 
                     full_run = T)

## we now export the fact table using our custom function "safe_fwrite"
## merari, just update this code for the current file, but do not run it as it exports to our server
#! safe_fwrite(cupc_1819_k12_school_fact, table_name = "cupc_k12_19_school_fact",
#!            data_year = 2019, data_source = "cde",
#!            data_description = "2018-19 calpads school upc k-12 file",
#!            data_type = "enrollment",
#!            user_note = "fact file.")
...
### explainer here: https://www.dremio.com/wiki/dimension-table/
### more info on snowflake schema which is our data schema: https://www.geeksforgeeks.org/dbms/snowflake-schema-in-data-warehouse-model/
cupck12_19_entities_dim <- cupc_1819_k12_school %>% 
  select(year, cds, county_code, district_code, school_code) %>% 
  distinct()

dim19_cupck12_districts <- cupc_1819_k12_school %>%
  select(year, district_code, district_name) %>% 
  distinct() %>% 
  arrange(district_name) %>% 
  mutate(district_code = as.integer(district_code))
...
dim19_cupck12_schools <- cupc_1819_k12_school %>%
  select(year, school_code, school_name) %>%
  distinct() %>% 
  arrange(school_code) %>% 
  mutate(school_code = as.integer(school_code)) %>% 
...
### we are going to make a dimension table for most categorical dummies we made 
dim19_cupck12_school_type <- cupc_1819_k12_school %>% 
  select(year, school_type, school_type_num) %>% 
  distinct() %>% 
  arrange(school_type_num) %>% 
  filter(!is.na(school_type_num))
...
dim19_cupck12_ed_option_type <- cupc_1819_k12_school %>% 
  select(year, ed_option_type, ed_option_type_num) %>% 
  distinct() %>% 
  arrange(ed_option_type_num) %>% 
  filter(!is.na(ed_option_type_num))
...
dim19_cupck12_charter_funding <- cupc_1819_k12_school %>% 
  select(year, charter_funding, charter_funding_num) %>% 
  distinct() %>% 
  arrange(charter_funding_num) %>% 
  filter(!is.na(charter_funding_num))
...
dim19_cupck12_charter <- cupc_1819_k12_school %>% 
  select(year, charter, charter_dummy) %>% 
  distinct() %>% 
  arrange(charter_dummy) %>% 
  filter(!is.na(charter_dummy))
...
dim19_cupck12_irc <- cupc_1819_k12_school %>% 
  select(year, irc, irc_num) %>% 
  distinct() %>% 
  arrange(irc_num) %>% 
  filter(!is.na(irc_num))
...
dim19_cupck12_low_grade <- cupc_1819_k12_school %>% 
  select(year, low_grade, low_grade_num) %>% 
  distinct() %>% 
  arrange(low_grade_num) %>% 
  filter(!is.na(low_grade_num))
...
dim19_cupck12_high_grade <- cupc_1819_k12_school %>% 
  select(year, high_grade, high_grade_num) %>% 
  distinct() %>% 
  arrange(high_grade_num) %>% 
  filter(!is.na(high_grade_num))
...
dim19_cupck12_calpads_fall1_cert <- cupc_1819_k12_school %>% 
  select(year, calpads_fall1_cert, calpads_fall1_cert_num) %>% 
  distinct() %>% 
  arrange(calpads_fall1_cert_num) %>% 
  filter(!is.na(calpads_fall1_cert_num))
...
validate_primary_key(cupck12_19_entities_dim, "cds", full_run = T)
#! safe_fwrite(cupck12_19_entities_dim, table_name = "cupck12_school_19_entities",
#!             dimension_type = "annualized", data_source = "cde",
#!             data_year = 2019, data_type = "dim",
#!             data_description = "2018-19 calpads k-12 school-level upc entities dim table",
#!             user_note = "dim table.")

validate_primary_key(dim19_cupck12_districts, "district_code", full_run = T)
#! safe_fwrite(dim19_cupck12_districts, table_name = "cupck12_school_19_districts",
#!             data_year = 2019, data_source = "cde",
#!             dimension_type = "annualized", data_type = "dim",
#!             data_description = "unique list of school districts calpads k-12 school-level upc 2019.",
#!             user_note = "dim table.")

validate_primary_key(dim19_cupck12_schools, "school_code", full_run = T)
#! safe_fwrite(dim19_cupck12_schools, table_name = "cupck12_school_19_schools",
#!             data_year = 2019, data_source = "cde",
#!             dimension_type = "annualized", data_type = "dim",
#!             data_description = "unique list of school schools calpads k-12 school-level upc 2019.",
#!             user_note = "dim table.")

validate_primary_key(dim19_cupck12_ed_option_type, "ed_option_type_num", full_run = T)
#! safe_fwrite(dim19_cupck12_ed_option_type, table_name = "dim19_cupck12_school_ed_option_type",
#!             data_year = 2019, data_source = "cde",
#!             dimension_type = "annualized", data_type = "dim",
...
#!             data_year = 2019, data_source = "cde",
#!             dimension_type = "annualized", data_type = "dim",
#!             data_description = "dimension table for nslp status in calpads k12 school-level.",
#!             user_note = "dim table.")

validate_primary_key(dim19_cupck12_charter_funding, "charter_funding_num", full_run = T)
#! safe_fwrite(dim19_cupck12_charter_funding, table_name = "dim19_cupck12_school_charter_funding",
#!             data_year = 2019, data_source = "cde",
#!             dimension_type = "annualized", data_type = "dim",
...
validate_primary_key(dim19_cupck12_irc, "irc_num", full_run = T)
#! safe_fwrite(dim19_cupck12_irc, table_name = "dim19_cupck12_school_irc",
#!             data_year = 2019, data_source = "cde",
#!             dimension_type = "annualized", data_type = "dim",
...
validate_primary_key(dim19_cupck12_low_grade, "low_grade_num", full_run = T)
#! safe_fwrite(dim19_cupck12_low_grade, table_name = "dim19_cupck12_school_low_grade",
#!             data_year = 2019, data_source = "cde",
#!             dimension_type = "annualized", data_type = "dim",
...
validate_primary_key(dim19_cupck12_high_grade, "high_grade_num", full_run = T)
#! safe_fwrite(dim19_cupck12_high_grade, table_name = "dim19_cupck12_school_high_grade",
#!             data_year = 2019, data_source = "cde",
#!             dimension_type = "annualized", data_type = "dim",
...
validate_primary_key(dim19_cupck12_calpads_fall1_cert, "calpads_fall1_cert_num", full_run = T)
#! safe_fwrite(dim19_cupck12_calpads_fall1_cert, table_name = "dim19_cupck12_school_calpads_fall1_cert",
#!             data_year = 2019, data_source = "cde",
#!             dimension_type = "annualized", data_type = "dim",
